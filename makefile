prog: main.o Robot.o RobotFactory.o RobotMixeur.o RobotPoussiere.o RobotMineur.o RobotPoussiere.o RobotMineur.o SortList.o
	g++ -Wall -o prog SortList.o Robot.o RobotFactory.o RobotMixeur.o RobotPoussiere.o main.o RobotMineur.o
...
main.o: main.cpp RobotMixeur.h Robot.h RobotFactory.h RobotPoussiere.h SortList.h RobotMineur.h
	g++ -Wall -c main.cpp
